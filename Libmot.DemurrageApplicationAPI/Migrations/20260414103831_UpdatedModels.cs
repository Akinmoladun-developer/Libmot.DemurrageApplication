    ...
    public partial class UpdatedModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemurrageRates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginState = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FreeDaysExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PickedUpAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDemurrageActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipments_AspNetUsers_DriverUserId",
            ...
            migrationBuilder.CreateTable(
                name: "DemurrageAccruals",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipmentId = table.Column<int>(type: "int", nullable: false),
                    DemurrageRateId = table.Column<int>(type: "int", nullable: false),
                    AccrualDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DayCount = table.Column<int>(type: "int", nullable: false),
                    DailyRateApplied = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemurrageAccruals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DemurrageAccruals_DemurrageRates_DemurrageRateId",
                        column: x => x.DemurrageRateId,
                        principalTable: "DemurrageRates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DemurrageAccruals_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DisputeLogs_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_DisputeLogs_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "DemurrageRates",
                columns: new[] { "Id", "CreatedAt", "CreatedByUserId", "DailyRate", "DayFrom", "DayTo", "EffectiveFrom", "EffectiveTo", "IsActive", "TierName" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "system", 2000m, 8, 14, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, "Tier 1" },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "system", 5000m, 15, 21, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, "Tier 2" },
                    { 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "system", 10000m, 22, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, "Tier 3" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DemurrageAccruals_DemurrageRateId",
                table: "DemurrageAccruals",
                column: "DemurrageRateId");

            migrationBuilder.CreateIndex(
                name: "IX_DemurrageAccruals_ShipmentId",
                table: "DemurrageAccruals",
                column: "ShipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DisputeLogs_InvoiceId",
                table: "DisputeLogs",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_DisputeLogs_ShipmentId",
                table: "DisputeLogs",
                column: "ShipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_DriverUserId",
                table: "Shipments",
                column: "DriverUserId");
